...
###########################################################
# MODEL BINOMIAL SPATIO TEMPORAL
...
data = read.csv(file = '~/Dropbox/Red lobster project/Data/data_filtered_complete.csv')
...
#mesh = readRDS('~/Dropbox/Red lobster project/Data/mesh.rds') 
...
#3. Projector matrix
Aspte<- inla.spde.make.A(mesh=mesh, loc=x_loc_utm, group = data_1t$Year)#NEW
...
data_pred = read.csv('Data/var_pred_c.csv')
...
#Plot the posterior
par(mfrow = c(3, 2), mar = c(3, 3.5, 0, 0), mgp = c(1.5, 0.5, 0), las = 0) 
